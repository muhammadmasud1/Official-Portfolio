...
const CheckoutPage: React.FC<Props> = ({ lang, user }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const savedEnrollments = JSON.parse(localStorage.getItem('huayu_enrollments') || '[]');
    localStorage.setItem('huayu_enrollments', JSON.stringify([...savedEnrollments, enrollmentData]));
