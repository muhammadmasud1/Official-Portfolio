  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (formData.email === 'admin@gmail.com' && formData.password === 'admin') {
        ...
        localStorage.setItem('huayu_user', JSON.stringify(admin));
        setUser(admin);
        navigate('/admin');
        return;
      }
      ...
      const foundUser = allUsers.find(u => u.email.toLowerCase() === formData.email.toLowerCase() && u.password === formData.password);
