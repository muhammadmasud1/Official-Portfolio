...
const BookCheckoutPage: React.FC<Props> = ({ lang, user }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulated high-fidelity persistence
    const savedOrders = JSON.parse(localStorage.getItem('huayu_book_orders') || '[]');
    localStorage.setItem('huayu_book_orders', JSON.stringify([...savedOrders, orderData]));
